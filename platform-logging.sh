...
$JAVAC --module-path target/dependency -d target/logging/app-classes src/main/logging/java9/jvm/platform_logging/app/*.java
...
echo " > running app"
$JAVA --module-path target/logging/mods:target/dependency -m app
